  ...
  return (
    <article className="flex flex-col gap-5 rounded-[28px] border border-white/20 bg-white/10 p-5 text-white/80 shadow-[0_24px_50px_-36px_rgba(148,163,184,0.75)] backdrop-blur-2xl transition duration-200 hover:-translate-y-1 hover:border-white/40 hover:bg-white/20">
      ...
      <div className="grid gap-2.5 sm:grid-cols-2">
        <Button
          size="lg"
          className="w-full rounded-full border border-white/20 bg-white/20 text-xs font-semibold uppercase tracking-[0.3em] text-white shadow-[0_18px_40px_-28px_rgba(244,244,245,0.6)] hover:bg-white/30"
          onClick={handleAdd}
        ...
        <Button
          variant="ghost"
          size="lg"
          className="w-full rounded-full border border-sky-400/30 bg-sky-500/10 text-xs font-semibold uppercase tracking-[0.3em] text-white hover:border-sky-400/50 hover:bg-sky-500/20"
